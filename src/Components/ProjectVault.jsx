...
const ProjectVault = ({ onClose }) => {
  ...
  const projects = [
    ...
    },
    {
      ...
      tech: ["Next.js", "Node.js", "Zustand", "Fabric.js", "MongoDB", "Shadcn UI"]
    },
    {
      id: "sitegen",
      title: "SiteGen",
    ...
    >
      ...
      >
                ...
                <div className="p-5">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="bg-indigo-100 text-indigo-800 text-xs font-bold px-2 py-1 rounded-full">
                      {project.id === 'uninest' ? 'Student' : project.id === 'designflow' ? 'Design' : 'AI'}
                    </div>
                  </div>
          ...
          {activeProject && (
            ...
            >
              <motion.div
                ...
                exit={{ scale: 0.95 }}
              >
                {projects.map(project => project.id === activeProject && (
                        ...
                        <div>
                          ...
                          <div className="mt-6">
                            ...
                            <div className="space-y-2 text-gray-700">
                              <p>
                                <span className="font-medium">Status:</span> {project.id === 'uninest' ? 'Live' : 'Active Development'}
                              </p>
                              <p>
                                <span className="font-medium">Category:</span> {project.id === 'uninest' ? 'Student Housing' : project.id === 'designflow' ? 'Design Tool' : 'AI Development'}
                              </p>
                              <p>
                                <span className="font-medium">Repository:</span> {project.link}
                              </p>
                            </div>
                          </div>
                        </div>
        ...
        <div className="p-6 border-t border-gray-200 text-center text-sm text-gray-500">
          {projects.length} innovative projects in the vault • Built with passion and modern tech
        </div>
      </motion.div>
    </motion.div>
  );
